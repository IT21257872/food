...
function AllTable() {
    ...
    useEffect(() => {
           axios.get('https://food-wmly.onrender.com/table/').then(res => {
               setTables(res.data)
       ...
       const deleteTable = (e) =>{
        ...
        axios.delete(`https://food-wmly.onrender.com/table/${tableId}`).then((res) => {
            console.log(res.data)
            alert('Table Deleted')
    ...
    const filterPackages = async (e) => {
        ...
        const response = await axios.get(
            'https://food-wmly.onrender.com/table/'
          );
