...
function AllBookings() {
    ...
    useEffect(() => {
           axios.get('https://food-wmly.onrender.com/tablebooking/').then(res => {
       ...
       const deleteBookings = (e) =>{
        ...
        axios.delete(`https://food-wmly.onrender.com/tablebooking/${tableId}`).then((res) => {
            console.log(res.data)
    ...
    const filterBookings = async (e) => {
        ...
        const response = await axios.get(
            'https://food-wmly.onrender.com/tablebooking/'
          );
