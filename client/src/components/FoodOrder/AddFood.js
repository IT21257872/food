...
const AddFood = () => {
  ...
  const changeOnClick = (e) => {
    ...
    if (form.checkValidity() === false) {
      ...
      axios
        .post("http://localhost:5000/food/admin/add", {
          foodName: foodName,
    ...
    <div className="">
      <section class="intro">
        <div class="bg-image h-100 ">
          <div
            class="mask d-flex align-items-center h-100 pt-4 pb-4"
            style={{ backgroundColor: "hsl(0,0%,75%,0.2)" }}
          >
            <div class="container">
                  ...
                  <div class="card" style={{ borderRadius: "1rem" }}>
                    <div class="row g-0">
                      ...
                      <div
                        ...
                        style={{ backgroundColor: "hsl(0,0%,75%,0.1)" }}
                      >
