...
function MyFoodOrders() {
    ...
    useEffect((e) => {
        ...
        axios.get(`https://food-wmly.onrender.com/foodorder/book/${ids}`).then(res => {
    ...
    const deleteOrder = (e) =>{
        ...
        axios.delete(`https://food-wmly.onrender.com/foodorder/admin/delete/${orderid}`).then((res) => {
            console.log(res.data)
            alert('Order Deleted')
   ...
   const setaa = (id)=>{
      ...
      const data={
       ...
       axios.put(`https://food-wmly.onrender.com/foodorder/admin/update/${id}`, data);
      window.location.reload();
