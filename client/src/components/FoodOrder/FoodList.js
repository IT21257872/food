        ...
        <div>
          ...
          <div class=" " style={{ marginTop: "50px" }}>
            <Row
              ...
              id="by"
              class="rounded"
              style={{ marginInlineStart: "40px", marginInlineEnd: "50px" }}
            >
              {this.state.foods.map((food, idx) => (
                <div>
                  <div class="col-md-! mb-4">
                    <div
                      class="card-sl cardf-sl cardsh"
                    ...
                    >
                      ...
                      <div class="card-text cardf-text">
                        Use your Food Factory account to order delivery from The
                        Food Factory.
                      </div>
                      <div class="card-text cardf-text">
                        <div class=" lower">
                          <div class="text-end" style={{ marginRight: "20px" }}>
                            <h4>Rs. {food.price}</h4>
                          </div>
                        </div>
                      </div>
                      <a
                        href={`/food/order/${food._id}`}
                        class="card-button cardf-button planta"
                      >
                        {" "}
                        Buy Now
                      </a>
